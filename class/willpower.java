...
public class Willpower{
  ...
  public LServo = new Servo(LServoPort); //constructor for left servo
	public RServo = new Servo(RServoPort); // constructor for right servo
	public myRobot = new RobotDrive( FLP, BLP, FRP, BRP);
	public myRobot = new RobotDrive( LMotor, RMotor); //constructor for myRobot, paramaters are ports
	public xbox = new XboxController(0); //constructor for xbox controller
	public timer = new Timer;
	public autoTimer = new Timer;
	public teleTime = new Timer;
